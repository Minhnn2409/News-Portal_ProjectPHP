<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#districts" aria-expanded="false"
            ...
            <div class="collapse" id="districts">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{route('subdistricts')}}">SubDistricts</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item menu-items">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="website">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="{{route('websites.create')}}">Add website link</a>
                    </li>
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="gallery">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="{{route('photos')}}">Photos gallery</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="{{route('videos')}}">Videos gallery</a></li>
                </ul>
            </div>
        </li>
