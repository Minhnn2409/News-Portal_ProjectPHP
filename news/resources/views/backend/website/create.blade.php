        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="{{route('websites.store')}}">
                        @csrf
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputUsername1" name="website_name"
                                   placeholder="Please type website name in English">
                        </div>
                        @error('website_name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputUsername1" name="website_link"
                                   placeholder="Please type website link in English">
                        </div>
                        @error('website_link')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
