                ...
                <div class="card-body">
                    ...
                    <div class="template-demo">
                        <a href="{{route('districts.create')}}">
                            <button type="button" class="btn btn-primary btn-fw" style="float: right">Add district
                            </button>
                        </a>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($districts as $district)
                                <tr>
                                    ...
                                    <td> {{$district->district_vie}}</td>
                                    <td>
                                        <a href="{{route('districts.edit', $district->id)}}"
                                           class="btn btn-info">Edit</a>
                                        <a href="{{route('districts.delete', $district->id)}}" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
